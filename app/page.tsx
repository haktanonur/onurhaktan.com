    ...
    <div className= "max-w-3xl mx-auto">
      <div className="flex-1 pb-4 md:pb-6 lg:pb-6">
        ...
        <div className="content mt-6">
          ...
          <p className="mb-3">⌨️ I develop web services and full stack projects using <b>Java, Spring Framework, C# and .NET Frameworks</b> technologies.</p>
          ...
          <div className="mb-3">
            ...
            <div>
              <div className="flex flex-wrap gap-y-3 sm:grid-cols-3 lg:grid-cols-2 space-x-2 pt-2 "> 
                ...
                <img alt="MicrosoftSQLServer" src="https://img.shields.io/badge/Microsoft%20SQL%20Server-CC2927?style=for-the-badge&logo=microsoft%20sql%20server&logoColor=white"></img>
                ...
                <img alt="Visual Studio" src="https://img.shields.io/badge/Visual%20Studio-5C2D91.svg?style=for-the-badge&logo=visual-studio&logoColor=white"></img>
