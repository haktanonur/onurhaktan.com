      ...
      <div className="flex-1 pb-4 md:pb-6 lg:pb-6">
        <div className="content md:mt-2 lg:mt-4 flex flex-col items-center">
          ...
          <div className="flex space-x-5 pt-6">
            <a href="https://github.com/haktanonur" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <svg
            ...
            <a href="https://www.linkedin.com/in/onur-haktan/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-amber-400 hover:text-amber-500"
            ...
            <a href="mailto:onurhaktann@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="Email">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-amber-400 hover:text-amber-500"
            ...
            <a href="https://medium.com/@onurhaktan" target="_blank" rel="noopener noreferrer" aria-label="Medium">
          ...
          <div className="mb-3">
            ...
            <div>
              <div className="flex flex-wrap gap-y-3 sm:grid-cols-3 lg:grid-cols-2 space-x-2 pt-2 "> 
                ...
                <img alt="Redis" src="https://img.shields.io/badge/redis-%23DD0031.svg?style=for-the-badge&logo=redis&logoColor=white"></img>
                <img alt="RabbitMQ" src="https://img.shields.io/badge/Rabbitmq-FF6600?style=for-the-badge&logo=rabbitmq&logoColor=white)"></img>
                <img alt="ApacheKafka" src="https://img.shields.io/badge/Apache%20Kafka-000?style=for-the-badge&logo=apachekafka"></img>
